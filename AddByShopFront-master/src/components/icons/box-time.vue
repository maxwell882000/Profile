<template>
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M3.16797 7.44006L11.998 12.55L20.7679 7.47003" stroke="#29334B" stroke-width="1.5" stroke-linecap="round"
          stroke-linejoin="round"/>
    <path d="M12 21.61V12.54" stroke="#29334B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    <path
        ...
        stroke="#29334B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    <path
        ...
        stroke="#29334B" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M19.25 16.75V18.25L18 19" stroke="#29334B" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
          stroke-linejoin="round"/>
  </svg>
</template>