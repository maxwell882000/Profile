    ...
    if 'key' in request.GET:
        try:
            ...
            if report.type_report == 0:
                return HttpResponseRedirect('pdf/{}/'.format(report.key))
            elif report.type_report == 1:
                return HttpResponseRedirect('pdf/additional/{}/'.format(report.key))
            elif report.type_report == 2:
                return HttpResponseRedirect('pdf/enumeration/{}/'.format(report.key))
            elif report.type_report == 3:
                return HttpResponseRedirect('pdf/disposable/{}/'.format(report.key))
