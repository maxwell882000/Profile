...
class MainController extends ApiController
{
    ...
    {
        Log::info("IS MOBILE");
        Log::info($this->request->get("isMobile"));
        return $this->result([
            ...
            "popular_category" => $request->get("isMobile") ? CategoryInMain::active()->onlyChild()->orderByOrder()->take(6)->get() : [],
            "hit_products" => ProductCard::joinHitProduct()->take(10)->get(),
    ...
    {
        return $this->result(CategoryInHomeApi::all());
    }
