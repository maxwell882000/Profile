...
namespace App\Http\Livewire\Admin\Pages\App\Domain\Policies\Front\Main\PolicyIndex;  // 1  --- namespace
...
class PolicyIndex extends BaseLivewire
{
    ...
    {
        return 'livewire.admin.pages.app-domain-policies-front-main-policy-index.policy-index'; //4  --- path to blade
    }
