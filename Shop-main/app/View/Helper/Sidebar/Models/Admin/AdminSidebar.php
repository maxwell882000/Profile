        ...
        return new \SideBarList(
            [
                ...
                new \SideBarList([
                    ...
                    new \SideBarDrop(__("Категории в главной странички"), CategoryInHomeRouteHandler::new())
                ],
                    __("Раздел Категорий"),
                    "fa-archive"
                ),
                new \SideBarList([
                    ...
                    new \SideBarDrop(__("Вопросы и ответы"), QuestionAndAnswerRouteHandler::new())
                ],
                    __("Общие"),
                    "fa-inbox"
                ),
                ...
                new \SideBarList([
                    ...
                    new \SideBarDrop(__("Ручная рассрочка"), CustomInstallmentRouteHandler::new()),
                ...
                new \SideBarDrop(__("Политика и конфедециальность"), PolicyRouteHandler::new(), "fa-file"),
