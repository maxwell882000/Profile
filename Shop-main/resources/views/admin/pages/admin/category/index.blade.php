...
@section("content")
    ...
    <div class="flex flex-col space-y-1">
        ...
        <div class="flex flex-row justify-between pr-10">
            ...
            <div class='self-end'>
                    <x-helper.button.main_button href='{{route("admin.category.create", array_merge([], \Request::query())) ?? ""}}'>
                              {{__('Создать')}}
...
<livewire:admin.pages.category-index.category-index
            :filterBy="['depth' => 1,'order_by_order' => 1,]" />
        </div>
    </div>
@endsection
