...
@section("content")
    ...
    <div class="flex flex-col space-y-1">
        ...
        <div class="flex flex-row justify-between pr-10">
            <x-helper.text.title>{{__("Категории в начальной странице") ?? ""}}</x-helper.text.title>
            <div class='self-end'>
                    <x-helper.button.main_button href='{{route("admin.category_in_home.create", array_merge([], \Request::query())) ?? ""}}'>
                              {{__('Создать')}}
...
<livewire:admin.pages.category-in-home-index.category-in-home-index />
        </div>
    </div>
@endsection
