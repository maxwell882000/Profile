...
<livewire:admin.pages.lenta-edit.product-nested
                :attachEntityId='$entity->id'
                :attachEntity='get_class($entity)'
                keyToAttach='productAccept'
                :filterBy='["lenta_id" => "$entity->id"]'
...
<livewire:components.file.file-uploading-without-entity
                    ...
                    :mediaInitial='$entity->left_image_ru ?? ""'
                    wire:key=''
                     />			
<livewire:components.file.file-uploading-without-entity
                    ...
                    :mediaInitial='$entity->left_image_uz ?? ""'
                    wire:key=''
                     />			
<livewire:components.file.file-uploading-without-entity
                    ...
                    :mediaInitial='$entity->left_image_en ?? ""'
                    wire:key=''
                     />
