...
<x-helper.input.input name='phone_verify' type='date'
            label='{{__("Телефон подтверждён")}}' value='{{old("phone_verify") ?? $entity->phone_verify ?? " "}}' id='phone_verify' oninput='' placeholder=''  onkeyup=""  />
...
<livewire:components.file.file-uploading-without-entity
                    ...
                    :mediaInitial='$entity->avatar->avatar ?? ""'
                    wire:key=''
                     />
<livewire:components.file.file-uploading-without-entity
                    ...
                    :mediaInitial='$entity->userCreditData->crucialData->passport ?? ""'
                    wire:key=''
                     />
<livewire:components.file.file-uploading-without-entity
                    ...
                    :mediaInitial='$entity->userCreditData->crucialData->passport_reverse ?? ""'
                    wire:key=''
                     />
<livewire:components.file.file-uploading-without-entity
                    ...
                    :mediaInitial='$entity->userCreditData->crucialData->user_passport ?? ""'
                    wire:key=''
                     />
