...
<x-helper.text.text_key key="Сальдо" value='{{$entity->saldo_show ?? ""}} ' class_value='App\Domain\Core\Front\Admin\Form\Attributes\Models\KeyTextAttribute'></x-helper.text.text_key>			
