    ...
    <div class="w-full flex-1 space-y-4">
        ...
        ." №" . ($index + 1)' 	class='space-y-6 flex flex-wrap justify-between'>
            ...
            Название заголовка
                 ...
                 <x-helper.input.input name='headerText->{{$index}}->text[ru]' class_div='w-1/4' label='{{__("на русском языке")}}'  value='{{old("headerText->{$index}->text") ? old("headerText->{$index}->text")["ru"] ?? $entity->text["ru"] ?? " " : $entity->text["ru"] ?? " "}}'  /><x-helper.input.input name='headerText->{{$index}}->text[uz]' class_div='w-1/4' label='{{__("o`zbek tilda")}}'  value='{{old("headerText->{$index}->text") ? old("headerText->{$index}->text")["uz"] ?? $entity->text["uz"] ?? " " : $entity->text["uz"] ?? " "}}'  /><x-helper.input.input name='headerText->{{$index}}->text[en]' class_div='w-1/4' label='{{__("in english")}}'  value='{{old("headerText->{$index}->text") ? old("headerText->{$index}->text")["en"] ?? $entity->text["en"] ?? " " : $entity->text["en"] ?? " "}}'  />
             </div>
            </div>
...
<livewire:admin.pages.header-edit.header-key-value-dynamic 
        ...
        ." №" . ($index + 1)' 	class='space-y-6 flex flex-wrap justify-between'>
            ...
            Название заголовка
                 ...
                 <div class=' flex flex-row space-x-2'>
                 <x-helper.input.input name='headerText->{{$index}}->text[ru]' class_div='w-1/4' label='{{__("на русском языке")}}'  value='{{old("headerText->{$index}->text") ? old("headerText->{$index}->text")["ru"] ?? $value->text["ru"] ?? " " : $value->text["ru"] ?? " "}}'  /><x-helper.input.input name='headerText->{{$index}}->text[uz]' class_div='w-1/4' label='{{__("o`zbek tilda")}}'  value='{{old("headerText->{$index}->text") ? old("headerText->{$index}->text")["uz"] ?? $value->text["uz"] ?? " " : $value->text["uz"] ?? " "}}'  /><x-helper.input.input name='headerText->{{$index}}->text[en]' class_div='w-1/4' label='{{__("in english")}}'  value='{{old("headerText->{$index}->text") ? old("headerText->{$index}->text")["en"] ?? $value->text["en"] ?? " " : $value->text["en"] ?? " "}}'  />
             </div>
            </div>
