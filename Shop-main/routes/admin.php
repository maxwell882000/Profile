    ...
    Route::middleware('admin')->group(function () {
        Route::resources(
            [
                ...
                AdminRoutesInterface::CUSTOM_INSTALLMENT => \App\Http\Controllers\Admin\CustomInstallmentController::class,
                AdminRoutesInterface::LENTA => \App\Http\Controllers\Admin\LentaController::class,
                AdminRoutesInterface::POLICY => \App\Http\Controllers\Admin\PolicyController::class,
                AdminRoutesInterface::QUESTION => \App\Http\Controllers\Admin\QuestionController::class,
                AdminRoutesInterface::CATEGORY_IN_HOME => \App\Http\Controllers\Admin\CategoryInHomeController::class
            ]
        );
    });
