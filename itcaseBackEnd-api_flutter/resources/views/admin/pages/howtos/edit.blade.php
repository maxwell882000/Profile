...
@section('content')
    ...
    <div class="block">
        ...
        <!-- Form -->
        <form action="{{ route('admin.howtos.update', $howto->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
...
{{--                                       value="{{ $howto->getTranslation('title', 'ru') }}">--}}
{{--                                @error('title.ru')--}}
...
{{--                                          name="content[ru]">{{ $howto->getTranslation('content', 'ru') }}</textarea>--}}
{{--                                @error('content.ru')--}}
{{--                                <div id="val-username-error"--}}
{{--                                     class="invalid-feedback animated fadeInDown">{{ $message }}</div> @enderror--}}
{{--                            </div>--}}
...
{{--                                </label>--}}
{{--                                <input class="form-control" type="text" id="ru_url_label" name="url_label[ru]" value="{{ $howto->getTranslation('url_label', 'ru') }}">--}}
...
{{--                                       value="{{ $howto->getTranslation('title', 'en') }}">--}}
{{--                                @error('title.en')--}}
{{--                                <div id="val-username-error"--}}
{{--                                     class="invalid-feedback animated fadeInDown">{{ $message }}</div> @enderror--}}
{{--                            </div>--}}
...
{{--                                          name="content[en]">{{ $howto->getTranslation('content', 'en') }}</textarea>--}}
{{--                                @error('content.en')--}}
{{--                                <div id="val-username-error"--}}
{{--                                     class="invalid-feedback animated fadeInDown">{{ $message }}</div> @enderror--}}
{{--                            </div>--}}
...
{{--                                </label>--}}
{{--                                <input class="form-control" type="text" id="en_url_label" name="url_label[en]" value="{{ $howto->getTranslation('url_label', 'en') }}">--}}
...
{{--                                       value="{{ $howto->getTranslation('title', 'uz') }}">--}}
{{--                                @error('uz_title')--}}
{{--                                <div id="val-username-error"--}}
{{--                                     class="invalid-feedback animated fadeInDown">{{ $message }}</div> @enderror--}}
{{--                            </div>--}}
...
{{--                                          name="uz_content">{{ $howto->getTranslation('content', 'uz') }}</textarea>--}}
{{--                                @error('content.uz')--}}
{{--                                <div id="val-username-error"--}}
{{--                                     class="invalid-feedback animated fadeInDown">{{ $message }}</div> @enderror--}}
{{--                            </div>--}}
...
{{--                                </label>--}}
{{--                                <input class="form-control" type="text" id="uz_url_label" name="url_label[uz]" value="{{ $howto->getTranslation('url_label', 'uz') }}">--}}
...
{{--                </div>--}}
                <div class="form-group">
                    <div class="form-material floating form-material-primary">
                        <input type="text" name="url" id="url" value="{{ $howto->url }}" class="form-control">
